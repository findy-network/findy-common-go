...
type Protocol_Attributes struct {
	...
	Attrs []*Protocol_Attribute `protobuf:"bytes,1,rep,name=attrs,proto3" json:"attrs,omitempty"` // Attributes is the list itself.
}
...
var file_protocol_proto_rawDesc = []byte{
	...
	0x12, 0x09, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x2e, 0x76, 0x31, 0x22, 0xe0, 0x0a, 0x0a, 0x08,
