...
const (
	ModeCmd_NONE        ModeCmd_CmdType = 0 // Input cmd (typeID = NONE, input = true) aka query msg
...
type ModeCmd struct {
	...
	IsInput bool            `protobuf:"varint,2,opt,name=is_input,json=isInput,proto3" json:"is_input,omitempty"`               // this is input cmd, if not this is output cmd
...
// without ascking controller's help for it.
